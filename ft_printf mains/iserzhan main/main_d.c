...
int main()
{
	...
	printf("Test min max\n");
	   c1 = printf("|%%d|%%15d|  |%d|%15d|\n", 2147483647, 2147483647);
	c2 = ft_printf("|%%d|%%15d|  |%d|%15d|\n", 2147483647, 2147483647);
	error(c1, c2);

	printf("Test min max\n");
	   c1 = printf("|%%d|%%15d|%%-15d|            |%d|%15d|\n", 2147483647, 2147483647, 2147483647);
	c2 = ft_printf("|%%d|%%15d|%%-15d|            |%d|%15d|\n", 2147483647, 2147483647, 2147483647);
	error(c1, c2);
	...
	c1 = printf("|%.0d|%3.0d|\n", 0, 0);
	c2 = ft_printf("|%.0d|%3.0d|\n", 0, 0);

	    c1 = printf("|%.0d|%0.0d|%3.0d|%5.0d|%10.0d|\n", 0, 0, 0, 0, 0);
	c2 = ft_printf("|%.0d|%0.0d|%3.0d|%5.0d|%10.0d|\n", 0, 0, 0, 0, 0);
	error(c1, c2);
